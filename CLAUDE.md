...
## Stack
- Static single-file site: `rekindle.html` (~52KB, all inline CSS/JS) plus local assets.
...
## Page structure (sections in `rekindle.html`)
...
- Keep everything self-contained in `rekindle.html` unless there's a reason to split.
