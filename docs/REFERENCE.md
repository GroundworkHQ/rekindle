...
- **Orb reactivity**: her speaking drives `--orb-level` from her real PCM, adaptive-peak-normalized so loud syllables hit full swing; your speaking drives it from mic RMS (noise floor 0.006, gain 12). Caption em-dashes sanitized (Grok slips them despite the rule).
